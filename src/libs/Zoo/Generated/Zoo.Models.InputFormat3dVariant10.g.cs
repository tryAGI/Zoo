...
namespace Zoo
{
    ...
    public sealed partial class InputFormat3dVariant10
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Zoo.JsonConverters.InputFormat3dVariant10TypeJsonConverter))]
        public global::Zoo.InputFormat3dVariant10Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputFormat3dVariant10" /> class.
        /// </summary>
        /// <param name="coords">
        /// Co-ordinate system of input data.<br/>
        /// Defaults to the [KittyCAD co-ordinate system].<br/>
...
#endif
        public InputFormat3dVariant10(
            global::Zoo.CoordinateSystem coords,
            global::Zoo.UnitLength units,
            global::Zoo.InputFormat3dVariant10Type type)
        {
