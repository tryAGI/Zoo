...
namespace Zoo
{
    ...
    public sealed partial class InputFormat3dVariant9
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Zoo.JsonConverters.InputFormat3dVariant9TypeJsonConverter))]
        public global::Zoo.InputFormat3dVariant9Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputFormat3dVariant9" /> class.
        /// </summary>
        /// <param name="coords">
        /// Co-ordinate system of input data.<br/>
        /// Default Value: {"forward":{"axis":"y","direction":"negative"},"up":{"axis":"z","direction":"positive"}}
...
#endif
        public InputFormat3dVariant9(
            global::Zoo.CoordinateSystem? coords,
            bool? splitClosedFaces,
            global::Zoo.InputFormat3dVariant9Type type)
        {
            this.Coords = coords;
