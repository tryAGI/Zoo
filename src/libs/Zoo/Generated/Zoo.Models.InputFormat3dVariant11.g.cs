...
namespace Zoo
{
    ...
    public sealed partial class InputFormat3dVariant11
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Zoo.JsonConverters.InputFormat3dVariant11TypeJsonConverter))]
        public global::Zoo.InputFormat3dVariant11Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputFormat3dVariant11" /> class.
        /// </summary>
        /// <param name="coords">
        /// Co-ordinate system of input data.<br/>
        /// Default Value: {"forward":{"axis":"z","direction":"positive"},"up":{"axis":"y","direction":"positive"}}
...
#endif
        public InputFormat3dVariant11(
            global::Zoo.CoordinateSystem? coords,
            bool? splitClosedFaces,
            global::Zoo.InputFormat3dVariant11Type type)
        {
            this.Coords = coords;
