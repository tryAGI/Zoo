...
namespace Zoo
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Zoo.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Zoo.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Zoo.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Zoo.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Zoo.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Zoo.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Zoo.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Zoo.ApiException exception)
        ...
        private static global::Zoo.AutoSDKRequestOptions CloneRequestOptions(
            global::Zoo.AutoSDKRequestOptions? source)
        {
            var clone = new global::Zoo.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
