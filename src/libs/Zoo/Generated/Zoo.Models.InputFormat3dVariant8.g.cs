...
namespace Zoo
{
    ...
    public sealed partial class InputFormat3dVariant8
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Zoo.JsonConverters.InputFormat3dVariant8TypeJsonConverter))]
        public global::Zoo.InputFormat3dVariant8Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputFormat3dVariant8" /> class.
        /// </summary>
        /// <param name="coords">
        /// Co-ordinate system of input data.<br/>
        /// Defaults to the [KittyCAD co-ordinate system].<br/>
...
#endif
        public InputFormat3dVariant8(
            global::Zoo.CoordinateSystem coords,
            global::Zoo.UnitLength units,
            global::Zoo.InputFormat3dVariant8Type type)
        {
