...
{
    /// <inheritdoc />
    public class CreatedAtSortModeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Zoo.CreatedAtSortMode>
    {
        /// <inheritdoc />
        public override global::Zoo.CreatedAtSortMode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.CreatedAtSortModeVariant1), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.CreatedAtSortModeVariant2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Zoo.CreatedAtSortModeVariant1? createdAtSortModeVariant1 = default;
            global::Zoo.CreatedAtSortModeVariant2? createdAtSortModeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        createdAtSortModeVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        createdAtSortModeVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (createdAtSortModeVariant1 == null && createdAtSortModeVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Zoo.CreatedAtSortMode(
        ...
        public override void Write(
            ...
            global::Zoo.CreatedAtSortMode value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsCreatedAtSortModeVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.CreatedAtSortModeVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Zoo.CreatedAtSortModeVariant1> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Zoo.CreatedAtSortModeVariant1).Name}");
