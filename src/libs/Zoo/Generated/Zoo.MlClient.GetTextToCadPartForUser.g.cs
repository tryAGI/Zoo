...
namespace Zoo
{
    public partial class MlClient
    {
        ...
        private static readonly global::Zoo.EndPointSecurityRequirement s_GetTextToCadPartForUserSecurityRequirement0 =
        ...
        private static readonly global::Zoo.EndPointSecurityRequirement[] s_GetTextToCadPartForUserSecurityRequirements =
            new global::Zoo.EndPointSecurityRequirement[]
            {                s_GetTextToCadPartForUserSecurityRequirement0,
            };
        partial void PrepareGetTextToCadPartForUserArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid id);
        partial void PrepareGetTextToCadPartForUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid id);
        partial void ProcessGetTextToCadPartForUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTextToCadPartForUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Zoo.TextToCadResponse> GetTextToCadPartForUserAsync(
            global::System.Guid id,
            global::Zoo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetTextToCadPartForUserAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Zoo.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Zoo.AutoSDKHttpResponse<global::Zoo.TextToCadResponse>> GetTextToCadPartForUserAsResponseAsync(
            global::System.Guid id,
            global::Zoo.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTextToCadPartForUserArguments(
            ...
            var __authorizations = global::Zoo.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTextToCadPartForUserSecurityRequirements,
                operationName: "GetTextToCadPartForUserAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Zoo.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Zoo.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetTextToCadPartForUser",
                                methodName: "GetTextToCadPartForUserAsync",
                                pathTemplate: "$\"/user/text-to-cad/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTextToCadPartForUserResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Zoo.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTextToCadPartForUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Zoo.TextToCadResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Zoo.AutoSDKHttpResponse<global::Zoo.TextToCadResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Zoo.TextToCadResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
