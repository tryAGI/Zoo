...
namespace Zoo
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Zoo.AutoSDKRetryOptions Retry { get; set; } = new global::Zoo.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Zoo.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Zoo.IAutoSDKHook>();
        ...
        public global::Zoo.AutoSDKClientOptions AddHook(
            global::Zoo.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Zoo.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Zoo.AutoSDKClientOptions UseAuthorizationProvider(
            global::Zoo.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Zoo.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Zoo.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Zoo.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Zoo.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Zoo.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Zoo.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Zoo.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Zoo.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Zoo.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Zoo.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Zoo.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Zoo.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Zoo.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Zoo.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Zoo.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Zoo.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Zoo.AutoSDKClientOptions clientOptions,
            global::Zoo.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Zoo.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Zoo.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Zoo.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Zoo.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Zoo.IAutoSDKHook, global::Zoo.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Zoo.AutoSDKHookContext context)
        {
