...
{
    /// <inheritdoc />
    public class GltfPresentationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Zoo.GltfPresentation>
    {
        /// <inheritdoc />
        public override global::Zoo.GltfPresentation Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.GltfPresentationVariant1), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.GltfPresentationVariant2), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::Zoo.GltfPresentationVariant1? gltfPresentationVariant1 = default;
            global::Zoo.GltfPresentationVariant2? gltfPresentationVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        gltfPresentationVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        gltfPresentationVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (gltfPresentationVariant1 == null && gltfPresentationVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Zoo.GltfPresentation(
        ...
        public override void Write(
            ...
            global::Zoo.GltfPresentation value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsGltfPresentationVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Zoo.GltfPresentationVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Zoo.GltfPresentationVariant1> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Zoo.GltfPresentationVariant1).Name}");
