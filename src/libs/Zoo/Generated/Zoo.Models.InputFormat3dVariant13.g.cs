...
namespace Zoo
{
    ...
    public sealed partial class InputFormat3dVariant13
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Zoo.JsonConverters.InputFormat3dVariant13TypeJsonConverter))]
        public global::Zoo.InputFormat3dVariant13Type Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InputFormat3dVariant13" /> class.
        /// </summary>
        /// <param name="coords">
        /// Co-ordinate system of input data.<br/>
        /// Defaults to the [KittyCAD co-ordinate system].<br/>
...
#endif
        public InputFormat3dVariant13(
            global::Zoo.CoordinateSystem coords,
            global::Zoo.UnitLength units,
            global::Zoo.InputFormat3dVariant13Type type)
        {
